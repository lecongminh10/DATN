                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập tên" id="username" name="username" value="{{ old('username') }}">
                                    @error('username')
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" placeholder="Nhập số điện thoại" id="phone_number" name="phone_number" value="{{ old('phone_number') }}">
                                    @error('phone_number')
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" placeholder="" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}">
                                    @error('date_of_birth')
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" placeholder="example@gmail.com" id="email" name="email" value="{{ old('email') }}">
                                    @error('email')
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select" aria-label="Trạng thái người dùng">
                                        ...
                                        <option value="suspended" {{ old('status') == 'suspended' ? 'selected' : '' }}>Bị cấm</option>
                                    </select>
                                    @error('status')
