                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        <div class="input-group">
                                            <form method="GET" action="{{ route('admin.paymentgateways.index') }}">
                                                <div class="input-group">
                        ...
                        <div class="table-responsive table-card mb-4">
                            <table class="table align-middle  " id="tasksTable">
                                <thead class="table-light text-muted">
                                    <tr>
                                        ...
                                        <th data-sort="name">STT</th>
                                        <th data-sort="api_key">Tên</th>
                                        <th data-sort="secret_key">Khóa API</th>
                                        <th data-sort="gateway_type">Khóa bí mật</th>
                                        <th data-sort="gateway_type">Loại cổng thanh toán</th>
                                        <th data-sort="gateway_type">Hành động</th>
                                    </tr>
                                </thead>
                                <tbody class="list form-check-all" id="userTableBody">
                                    @foreach ($paymentGateway as $key => $value)
                                        <tr>
                                            ...
                                            <td class="client_name">{{ $value->api_key }}</td>
                                            <td class="client_name">{{ $value->secret_key }}</td>
                                            <td class="client_name">{{ $value->gateway_type }}</td>
                                            <td>
                                                @if ($value->name !== 'VNPay' && $value->name !== 'Cash')
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 ms-4">
                                                            <ul class="list-inline tasks-list-menu mb-0">
                                                                <li class="list-inline-item">
                                                                    <a
                                                                        href="{{ route('admin.paymentgateways.show', $value->id) }}">
                                                                        <i
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <a
                                                                        href="{{ route('admin.paymentgateways.edit', $value->id) }}">
                                                                        <i
                                                                ...
                                                                <li class="list-inline-item">
                                                                    ...
                                                                    <form id="deleteForm-{{ $value->id }}"
                                                                        action="{{ route('admin.paymentgateways.delete', $value->id) }}"
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">Chúng tôi đã tìm kiếm hơn 200k+ nhiệm vụ nhưng không tìm thấy
                                        nhiệm vụ nào cho bạn.</p>
                                </div>
                            </div>
                        </div>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                deleteMultipleBtn.addEventListener('click', function() {
                    ...
                    document.getElementById('modalTitle').innerText =
                        'Bạn có chắc chắn muốn xóa những cổng thanh toán này?';
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    searchInput.addEventListener('input', function() {
                        ...
                        rows.forEach(row => {
                            const nameCell = row.querySelector('.project_name');
