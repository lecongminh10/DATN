                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.brand.update', $brand->id) }}" method="POST"
                                ...
                                <div class="banner gap-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="image" id="image" class="d-none" accept="image/*"
                                            onchange="previewImageAsBackground(event, 'preview-container-1')">
                                        {{-- @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror --}}
                                        <div id="preview-container-1" class="preview-container mt-2">
                                            {{-- @if ($brand->image)
                                                <img src="{{ Storage::url($brand->image) }}" class="img-fluid" style="max-width: 100px;">
                                            @endif --}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Hidden input to ensure the value is sent when checkbox is unchecked -->
