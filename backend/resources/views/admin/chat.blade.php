                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                                        <img src="{{ asset('theme/assets/images/users/avatar-2.jpg')}}" class="rounded-circle avatar-xs" alt="">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            <div class="team-cover">
                <img src="{{ asset('theme/assets/images/small/img-9.jpg')}}" alt="" class="img-fluid" />
            </div>
            ...
            <div class="p-3 text-center">
                <img src="{{ asset('theme/assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto profile-img">
                <div class="mt-3">
