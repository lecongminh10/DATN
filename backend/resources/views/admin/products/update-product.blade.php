                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="datetime-local" class="form-control" name="promotion_end_time" value="{{ old('promotion_end_time',$product->promotion_end_time) }}" id="promotion_end_time" required>
