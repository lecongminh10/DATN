...
@section('style_css')
    <style>
        ...
        .list-group-item-attribute {
            ...
            padding: 0.75rem 1.25rem; /* Add padding for spacing */
            margin-bottom: -1px; /* Remove space between items */
        ...
        .list-group-item-attribute:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25); /* Shadow effect for focus */
        }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <form action="{{route('admin.products.addPostProduct')}}" method="POST" enctype="multipart/form-data" id="uploadForm" class="dropzone">
                        @csrf
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" id="code" value="{{ strtoupper(\Str::random(8)) }}">
                                                        @error('code')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" id="stock" onchange="getPrices()">
                                                        @error('stock')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number" class="form-control @error('price_regular') is-invalid @enderror" name="price_regular"  id="price_regular" onchange="getPrices()">
                                                        @error('price_regular')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number" class="form-control @error('price_sale') is-invalid @enderror" name="price_sale"  id="price_sale" onchange="getPrices()">
                                                        @error('price_sale')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="mt-3">
                                                        <label for="product_tags" class="form-label text-muted">Thẻ</label>
                                                        <select class="form-control" name="product_tags[]" id="choices-multiple-remove-button" placeholder="This is a placeholder" multiple>
                                                        </select>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label for="price_sale" class="form-label">Thời gian bảo hành </label>
                                                        <input type="number" class="form-control" name="warranty_period"  id="warranty_period">
                                                    </div>
                                                    <div class="row">
                                                        @php
                                                            $status = [
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="list-group col nested-list nested-sortable" id="nested-sortable">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- Editor container -->
                                        <textarea name="content" id="editor-container" style="height: 300px;"></textarea>
                                        @error('content')
                                        <div>
                                            <div class="invalid-feedback">
                                                {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            <div>
                                                <input type="file" name="product_galaries[][image_gallery]" id="product_galaries" class="hidden" multiple />
...
@section('scripte_logic')
    ...
    <script>
            ...
            $('.nested-sortable').sortable({
                ...
                update: function(event, ui) {
                    ...
                    const parentId = ui.item.parent().closest('.list-group-item').data('id'); // Get the new parent ID
    ...
    <script>
                ...
                document.querySelector("#uploadButton").onclick = function(event) {
                    ...
                    if (myDropzone.getAcceptedFiles().length > 0) {
                        ...
                        myDropzone.files.forEach(function(file, index) {
                            const checkbox = document.querySelector(`input[name="product_galaries[][is_main]"][data-index="${index}"]`);
                            ...
                            hiddenInput.name = `product_galaries[${index}][is_main]`; // Cấu trúc lại tên để tương ứng
        ...
        function initializeCheckboxes(checkbox) {
            const checkboxes = document.querySelectorAll('.is-main-checkbox'); // Lấy tất cả checkbox có class 'is-main-checkbox'
