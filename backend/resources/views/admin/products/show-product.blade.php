                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <textarea class="form-control" name="short_description" id="short_description"
                                                        value="{{ old('short_description', $product->short_description) }}" disabled>{{$product->short_description}}</textarea>
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    <label for="meta_title" class="form-label">SEO tiêu đề</label>
                                                    <textarea class="form-control" name="meta_title" id="meta_title" value="{{ old('meta_title', $product->meta_title) }}" disabled>{{$product->meta_title}}</textarea>
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    <label for="meta_description" class="form-label">SEO mô tả</label>
                                                    <textarea class="form-control" name="meta_description" id="meta_description"
                                                        value="{{ old('meta_description', $product->meta_description) }}" disabled>{{$product->meta_description}}</textarea>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="code" id="code"
                                                            value="{{ old(strtoupper(\Str::random(8)), $product->code) }}" disabled>
                                                        @error('code')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="stock" id="stock"
                                                            value="{{ old('stock', $product->stock) }}" disabled onchange="getPrices()">
                                                        @error('stock')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('price_regular', $product->price_regular) }}" disabled onchange="getPrices()">
                                                        @error('price_regular')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('price_sale', $product->price_sale) }}" disabled onchange="getPrices()">
                                                        @error('price_sale')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <select class="form-control" name="product_tags[]"
                                                            id="choices-multiple-remove-button" disabled
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- Editor container -->
                                        <textarea name="content" id="editor-container" style="height: 300px;" disabled>{{ $product->content }}</textarea>
                                        @error('content')
                                            <div>
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                            ...
                                                            <div class="d-flex p-2">
                                                                <div class="flex-shrink-0 me-3">
                                                                    <div class="avatar-sm bg-light rounded">
                                                                        <img data-dz-thumbnail class="img-fluid rounded d-block view-attribute-values"
                                                                            title="View" data-bs-toggle="modal" data-bs-target="#viewImageModal" data-image-url="{{$item->image_gallery}}"
        ...
        variant.forEach((variantData) => {
            ...
            $('#attributeList').append(`
                <tr class="variant-row"> <!-- Add class to identify variant rows -->
                    <input type="hidden" name="product_variants[${variantData.id}][id]" value="${variantData.id}" class="product_variants" disabled>
                    <input type="hidden" name="product_variants[${variantData.id}][attributes_values]" value="${attributeValueString}" class="product_variants" disabled>
                    <input type="hidden" name="product_variants[${variantData.id}][variant_image]" value="${variantData.variant_image}" class="product_variants" disabled>
                    ...
                    <td>
                        <input type="number" name="product_variants[${variantData.id}][original_price]" class="form-control original_price" id="original_price_${variantData.id}" disabled value="${variantData.original_price}" />
                    </td>
                    <td>
                        <input type="number" name="product_variants[${variantData.id}][price_modifier]" class="form-control price_modifier" id="price_modifier_${variantData.id}" disabled value="${variantData.price_modifier}" />
                    </td>
                    <td>
                        <input type="number" name="product_variants[${variantData.id}][stock]" class="form-control stock" min="0" value="${variantData.stock}" disabled />
                    </td>
                    <td>
                        <select disabled class="form-control status_attribute" name="product_variants[${variantData.id}][status]">
                    ...
                    <td>
                        <input disabled type="file" class="form-control" name="product_variants[${variantData.id}][variant_image]" />
                    </td>
            ...
            function addAttributeInput(attribute) {
                ...
                const attributeGroup = `
                    <div class="attribute-input-group row mb-2">
                        <input type="text" class="form-control col-lg-5" value="${attribute}" readonly disabled>
                        <div class="col-lg-5">
