                            ...
                            <form action="{{ route('admin.banner.banner_extra_update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="price_1" id="price_1" class="form-control" value="{{ $bannerExtra->price_1 ?? '' }}">
                                    </div>
                                    
                                    <!-- Price 2 -->
                                    <div class="col-md-4 mb-3">
                                        <label for="price_2" class="form-label">Giá 2</label>
                                        <input type="number" name="price_2" id="price_2" class="form-control" value="{{ $bannerExtra->price_2 ?? '' }}">
                                    </div>
                                    
                                    <!-- Price 3 -->
                                    <div class="col-md-4 mb-3">
                                        <label for="price_3" class="form-label">Giá 3</label>
                                        <input type="number" name="price_3" id="price_3" class="form-control" value="{{ $bannerExtra->price_3 ?? '' }}">
                                    </div>
                                </div>
