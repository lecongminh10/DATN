                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-lg">
                                            <img src="{{ Storage::url($user->profile_picture) }}"
                                                class="rounded-circle avatar-x2 img-thumbnail user-profile-image"
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-borderless mb-0">
                                                                        <tbody style="font-size: 12px">
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Họ tên :
                                                                                </th>
                                                                                <td class="text-muted">{{ $user->username }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                    ...
                                                    <div class="col-xxl-9">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <p>Bạn luôn muốn đảm bảo rằng các phông chữ của mình kết hợp
                                                                    tốt với nhau và cố gắng hạn chế số lượng phông chữ bạn
                                                                    sử dụng ở mức ba hoặc ít hơn. Hãy thử nghiệm và chơi đùa
                                                                    với các phông chữ mà bạn đã có trong phần mềm bạn đang
                                                                    làm việc với các trang web phông chữ uy tín. Đây có thể
                                                                    là mẹo thường gặp nhất mà tôi nhận được từ các nhà thiết
                                                                    kế mà tôi đã nói chuyện. Họ rất khuyến khích bạn sử dụng
                                                                    các phông chữ khác nhau trong một thiết kế, nhưng đừng
                                                                    phóng đại và đi quá xa.</p>
                                                                <!--end row-->
                                                            </div>
                                                            <!--end card-body-->
                                                        </div><!-- end card -->
