                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row gy-4">
                            ...
                            <div class=" col-md-6">
                                 <input type="text" disabled  name="parent_id"  class="form-control" value="{{ $data->parent_id ? $data->parent_id->name : 'No parent' }}">
                            </div>
                            <div class=" col-md-6">
                            {!! $data->is_active ? '<span class="badge bg-success"> Hoạt động </span>' :
                                        ' <span class="badge bg-danger"> Không hoạt động </span>'!!}
                            </div>
                            <div class=" col-md-6">
                                <label for="created_at" class="form-label">Created At</label>
                                <input disabled type="datetime" class="form-control" value="{{ $data['created_at'] }}">
                                <label for="updated_at" class="form-label">Updated At</label>
                                    <input disabled type="datetime" class="form-control" value="{{ $data['updated_at'] }}">   
                            </div>
                            <div class=" col-md-6">
