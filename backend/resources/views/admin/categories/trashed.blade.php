                            ...
                            <div class="live-preview">
                                <form id="delete-multiple-form"
                                    ...
                                    <div class="table-responsive">
                                        <div class="row g-4 mb-3">
                                            ...
                                            <div class="col-sm d-flex justify-content-end">
                                                <form action="{{ route('admin.categories.trashed.search') }}" method="GET"
                                                    class="d-flex" id="search-form">
                                                    @csrf
                                                                ...
                                                                <ul class="dropdown-menu"
                                                                    ...
                                                                    <li>
                                                                        <form
                                                                            ...
                                                                            @method('PATCH')
                                                                            <button type="submit"
                                                                                class="dropdown-item">Khôi phục</button>
                                                                        </form>
                                                                    </li>
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('admin.categories.hard-delete', $category->id) }}"
                                                                            method="POST"
                                                                            onsubmit="return confirm('Bạn có chắc chắn muốn xóa cứng danh mục này?');">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit" class="dropdown-item">Xóa
                                                                                cứng</button>
                                                                        </form>
                                                                    </li>
                                                                </ul>
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        <button type="button" id="delete-selected" class="btn btn-danger">Xóa cứng đã
                                            chọn</button>
                                    </div>
                                </form>
                            </div>
        ...
        <script>
            ...
            document.getElementById('restore-selected').addEventListener('click', function() {
                ...
                if (confirm('Bạn có chắc chắn muốn khôi phục các danh mục đã chọn?')) {
                    form.action =
                    "{{ route('admin.categories.trashed.restoreMultiple') }}"; // Thay đổi URL hành động cho khôi phục
                    form.submit();
                }
            });
