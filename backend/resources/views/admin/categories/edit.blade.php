                    ...
                    <form action="{{ route('admin.categories.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                @if($data->image)
                                    <img src="{{ Storage::url($data->image) }}" width="150" height="150" alt="Current Image" style="margin-top: 10px;">
                                @endif
                            </div><!--end col-->
                            ...
                            <div class="col-lg-12">
                                <div class="text-end">
                                    <a href="{{route('admin.categories.index')}}" class="btn btn-primary mx-2">Trở lại </a>
