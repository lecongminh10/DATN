            ...
            <div class="col-lg-9">
                ...
                <div class="banners-container m-b-2 owl-carousel owl-theme" data-owl-options="{
                    ...
                    <div class="banner banner1 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                        <figure class="w-100">
                            <img src="{{asset('themeclient/assets/images/demoes/demo1/banners/banner-1.jpg')}}" style="background-color: #dadada;" alt="banner">
                        </figure>
                    ...
                    <div class="banner banner2 text-uppercase banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                        <figure class="w-100">
                            <img src="{{asset('themeclient/assets/images/demoes/demo1/banners/banner-2.jpg')}}" style="background-color: #dadada;" alt="banner">
                        </figure>
                    ...
                    <div class="banner banner3 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInRightShorter" data-animation-delay="500">
                        <figure class="w-100">
                            <img src="{{asset('themeclient/assets/images/demoes/demo1/banners/banner-3.jpg')}}" style="background-color: #dadada;" alt="banner">
                        </figure>
                ...
                <div class="brands-slider owl-carousel owl-theme images-center appear-animate" data-animation-name="fadeIn" data-animation-duration="700" data-owl-options="{
                    ...
                    <img src="{{asset('themeclient/assets/images/brands/small/brand1.png')}}" width="140" height="60" alt="brand">
                    <img src="{{asset('themeclient/assets/images/brands/small/brand2.png')}}" width="140" height="60" alt="brand">
                    <img src="{{asset('themeclient/assets/images/brands/small/brand3.png')}}" width="140" height="60" alt="brand">
                    <img src="{{asset('themeclient/assets/images/brands/small/brand4.png')}}" width="140" height="60" alt="brand">
                    <img src="{{asset('themeclient/assets/images/brands/small/brand5.png')}}" width="140" height="60" alt="brand">
                    <img src="{{asset('themeclient/assets/images/brands/small/brand6.png')}}" width="140" height="60" alt="brand">
                </div>
                <!-- End .brands-slider -->
                    ...
                    <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="200">
                        <div class="product-column">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-4.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-4-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-5.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-5-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-6.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-6-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                    ...
                    <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                        <div class="product-column">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-7.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-7-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-8.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-8-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                    ...
                    <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="800">
                        <div class="product-column">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-9.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-9-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-10.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-10-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget ">
                                <figure>
                                    <a href="demo1-product.html">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-11.jpg')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('themeclient/assets/images/demoes/demo1/products/small/product-11-2.jpg')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo1-product.html">Brown-Black Men
                ...
                <div class="side-menu-wrapper text-uppercase mb-2 d-none d-lg-block">
                    ...
                    <nav class="side-nav">
                        <ul class="menu menu-vertical sf-arrows">
                            <li class="active"><a href="{{ route('client') }}"><i class="icon-home"></i>Home</a></li>
