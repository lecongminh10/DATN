...
Route::group([
    ...
    Route::prefix('categories')->group(function () {
        ...
        // Route::get('/statistics/{category}', [CategoryController::class, 'statistics'])->name('categories.statistics'); // Thống kê một danh mục
        // Route::get('/statistics', [CategoryController::class, 'allStatistics'])->name('categories.allStatistics'); // Thống kê tất cả danh mục
        // Route::get('/statistics/{category}', [CategoryController::class, 'statistics'])->name('categories.statistics'); // Thống kê một danh mục
        // Route::get('/statistics', [CategoryController::class, 'allStatistics'])->name('categories.all_statistics'); // Thống kê tất cả danh mục
    });
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('/statistics', [CategoryController::class, 'allStatistics'])->name('statistics');
            // Route::get('/statistics/{id}', [CategoryController::class, 'statistics'])->name('statistics');
            // Route::get('/all_statistics', [CategoryController::class, 'allStatistics'])->name('all_statistics');
        }
    ...
    // Route ngoài nhóm để xử lý phản hồi đã xóa mềm
    Route::get('/feedbacks-soft-deleted', [FeedbackController::class, 'showSoftDeleted'])->name('feedbacks.feedbacksSoftDeleted');
