...
class PermissionController extends Controller
{
    ...
    public function destroyPermission($id)
    {
        ...
        return redirect()->route('admin.admin.permissions.index')->with('error', 'An error occurred while deleting the category.');
    }
    ...
    public function destroyMultipleValues(Request $request)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', 'Các giá trị quyền đã được xóa thành công.');
    }
}
